...
(define c1-str/padding-character (string c0/escape #\u80))
(define c1-str/high-octal-preset (string c0/escape #\u81))
(define c1-str/break-permitted-here (string c0/escape #\u82))
(define c1-str/no-break-here (string c0/escape #\u83))
(define c1-str/index (string c0/escape #\u84))
(define c1-str/next-line (string c0/escape #\u85))
(define c1-str/start-of-selected-area (string c0/escape #\u86))
(define c1-str/end-of-selected-area (string c0/escape #\u87))
(define c1-str/horizontal-tabulation-set (string c0/escape #\u88))
(define c1-str/horizontal-tabulation-with-justification (string c0/escape #\u89))
(define c1-str/vertical-tabulation-set (string c0/escape #\u8A))
(define c1-str/parial-line-down (string c0/escape #\u8B))
(define c1-str/parial-line-up (string c0/escape #\u8C))
(define c1-str/reverse-line-feed (string c0/escape #\u8D))
(define c1-str/single-shift-2 (string c0/escape #\u8E))
(define c1-str/single-shift-3 (string c0/escape #\u8F))
(define c1-str/device-control-string (string c0/escape #\u90))
(define c1-str/private-use-1 (string c0/escape #\u91))
(define c1-str/private-use-2 (string c0/escape #\u92))
(define c1-str/set-transmission-state (string c0/escape #\u93))
(define c1-str/cancel-character (string c0/escape #\u94))
(define c1-str/message-waiting (string c0/escape #\u95))
(define c1-str/start-of-protected-area (string c0/escape #\u96))
(define c1-str/end-of-protected-area (string c0/escape #\u97))
(define c1-str/start-of-string (string c0/escape #\u98))
(define c1-str/single-graphic-character-introducer (string c0/escape #\u99))
(define c1-str/single-character-introducer (string c0/escape #\u9A))
(define c1-str/control-sequence-introducer (string c0/escape #\u9B))
(define c1-str/string-terminator (string c0/escape #\u9C))
(define c1-str/operating-system-command (string c0/escape #\u9D))
(define c1-str/privacy-message (string c0/escape #\u9E))
(define c1-str/application-program-command (string c0/escape #\u9F))
...
(define (string-fe-code? s)
  (string-code? s char-fe-code?))
...
(define (string-fs-code? s)
  (string-code? s char-fs-code?))
...
(define (string-fp-code? s)
  (string-code? s char-fp-code?))
  ...
  (and (string? s)
       (let* ((len (string-length s))
         ...
         (and
          (>= len 3)
          (char=? (string-ref s 0) c0/escape)
          (andmap char-nf-code? (string->list (substring s 1 last)))
          (char<=? #\u30 (string-ref s last) #\u7E)))))
